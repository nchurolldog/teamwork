...
<body>
  <div class="shell">
    ...
    <main class="content">
      ...
      <section class="grid">
        <article class="card metric featured span-3"><strong>4</strong><span>Managed Classes</span></article>
        <article class="card metric span-3"><strong>156</strong><span>My Students</span></article>
        <article class="card metric warning span-3"><strong>12</strong><span>Party Applications</span></article>
        <article class="card metric span-3"><strong>9</strong><span>Scholarship Reviews</span></article>

        <article class="card span-4">
          <h2>Personal Info</h2>
          <div class="info-list">
            <div class="info-row"><span>Employee ID</span><strong><%= currentUser.getAccount() %></strong></div>
            <div class="info-row"><span>Name</span><strong>Waiting for counselor profile</strong></div>
        ...
        <article class="card span-8">
          ...
          <table>
            ...
            <tbody>
              <tr><td>Michael Chen</td><td>SE-2301</td><td><span class="pill">Inspection</span></td><td><span class="pill">None</span></td><td>Normal</td></tr>
              <tr><td>Emma Williams</td><td>SE-2302</td><td><span class="pill warning">Pending</span></td><td><span class="pill">Submitted</span></td><td>Needs support</td></tr>
              <tr><td>Isabella Rossi</td><td>SE-2401</td><td><span class="pill">Approved</span></td><td><span class="pill">Approved</span></td><td>Normal</td></tr>
            </tbody>
          </table>
        </article>
        ...
        <article class="card span-6">
          ...
          <table>
            ...
            <tbody>
              <tr><td>Safety Education</td><td>SE-2301</td><td>A-201</td></tr>
              <tr><td>Scholarship Guidance</td><td>SE-2302</td><td>B-103</td></tr>
              <tr><td>Party Development</td><td>SE-2401</td><td>C-305</td></tr>
            </tbody>
          </table>
        </article>
        ...
        <article class="card span-6">
          <h2>Review Queue</h2>
          <div class="info-list">
            <div class="info-row"><span>Scholarship waiting</span><strong>9</strong></div>
            <div class="info-row"><span>Party applications waiting</span><strong>12</strong></div>
            <div class="info-row"><span>Students needing attention</span><strong>6</strong></div>
          </div>
        </article>
      </section>
    </main>
